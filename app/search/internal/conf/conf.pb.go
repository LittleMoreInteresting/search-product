...
type Data struct {
	...
	Es       *Data_Elasticsearch `protobuf:"bytes,3,opt,name=es,proto3" json:"es,omitempty"`
}
...
func (x *Data) GetEs() *Data_Elasticsearch {
	if x != nil {
		return x.Es
	}
	return nil
...
type Data_Elasticsearch struct {
	...
	Sniff         bool                 `protobuf:"varint,4,opt,name=sniff,proto3" json:"sniff,omitempty"`
	SniffTimeout  *durationpb.Duration `protobuf:"bytes,5,opt,name=sniff_timeout,json=sniffTimeout,proto3" json:"sniff_timeout,omitempty"`
	SniffInterval *durationpb.Duration `protobuf:"bytes,6,opt,name=sniff_interval,json=sniffInterval,proto3" json:"sniff_interval,omitempty"`
}
...
func (x *Data_Elasticsearch) GetEndpoints() []string {
	if x != nil {
		return x.Endpoints
	}
	return nil
...
func (x *Data_Elasticsearch) GetSniff() bool {
	if x != nil {
		return x.Sniff
	}
	return false
...
func (x *Data_Elasticsearch) GetSniffTimeout() *durationpb.Duration {
	if x != nil {
		return x.SniffTimeout
	}
	return nil
}

func (x *Data_Elasticsearch) GetSniffInterval() *durationpb.Duration {
	if x != nil {
		return x.SniffInterval
	}
	return nil
}
...
var file_conf_proto_rawDesc = []byte{
	...
	0x75, 0x74, 0x22, 0x8d, 0x05, 0x0a, 0x04, 0x44, 0x61, 0x74, 0x61, 0x12, 0x35, 0x0a, 0x08, 0x64,
	...
	0x12, 0x2e, 0x0a, 0x02, 0x65, 0x73, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1e, 0x2e, 0x6b,
	...
	0x75, 0x74, 0x1a, 0xfd, 0x01, 0x0a, 0x0d, 0x45, 0x6c, 0x61, 0x73, 0x74, 0x69, 0x63, 0x73, 0x65,
	...
	,
...
var file_conf_proto_depIdxs = []int32{
	...
	7,  // 6: kratos.api.Data.es:type_name -> kratos.api.Data.Elasticsearch
	...
	8,  // 11: kratos.api.Data.Elasticsearch.sniff_timeout:type_name -> google.protobuf.Duration
	8,  // 12: kratos.api.Data.Elasticsearch.sniff_interval:type_name -> google.protobuf.Duration
